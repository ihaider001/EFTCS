...
```
cd existing_repo
git remote add origin https://gitlab.nestorbird.com/nestorbird/eftc/eftcssaudi-erp-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.nestorbird.com/nestorbird/eftc/eftcssaudi-erp-app/-/settings/integrations)
